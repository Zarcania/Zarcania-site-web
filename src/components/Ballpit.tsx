...
const X = {
  count: 50,
  colors: [0x06b6d4, 0x3b82f6, 0x22d3ee],
...
const Ballpit = ({ className = '', followCursor = false, ...props }) => {
  ...
  useEffect(() => {
    ...
    // Désactiver Ballpit sur mobile pour les performances
    const isMobile = window.innerWidth < 768;
    if (isMobile) {
      // Créer un canvas simple avec un dégradé statique
    ...
    try {
      ...
      console.warn('Ballpit initialization error:', error);
    }
